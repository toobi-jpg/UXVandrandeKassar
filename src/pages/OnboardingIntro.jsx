...
const OnboardingIntro = () => {
  return (
    <div className="w-full h-full bg-[#FADCD9] shadow-2xl overflow-hidden relative flex flex-col justify-between transition-colors duration-300">
        ...
        <div className="px-8 pb-10">
            <div className="mb-10 space-y-4 font-fredoka">
                <p className="text-lg text-gray-800 leading-relaxed font-bold tracking-tight">
                    Utforska kartan för att hitta aktiva vandrande kassar i ditt närområde. Välj en kasse som passar dig.
                </p>
            </div>
